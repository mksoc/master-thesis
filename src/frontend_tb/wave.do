...
add wave -noupdate -radix decimal -radixshowbase 1 /frontend_tb/dut_fetch_stage/u_fetch_unit/prev_pc_q
...
add wave -noupdate -radix decimal -childformat {{/frontend_tb/dut_fetch_stage/u_fetch_unit/cache_out_i.pc -radix decimal} {/frontend_tb/dut_fetch_stage/u_fetch_unit/cache_out_i.line -radix decimal}} -radixshowbase 1 -subitemconfig {/frontend_tb/dut_fetch_stage/u_fetch_unit/cache_out_i.pc {-radix decimal -radixshowbase 1} /frontend_tb/dut_fetch_stage/u_fetch_unit/cache_out_i.line {-radix decimal -radixshowbase 1}} /frontend_tb/dut_fetch_stage/u_fetch_unit/cache_out_i
add wave -noupdate -radix decimal -radixshowbase 1 /frontend_tb/dut_fetch_stage/u_fetch_unit/line_reg
add wave -noupdate -radix binary -radixshowbase 1 /frontend_tb/dut_fetch_stage/u_fetch_unit/line_valid
add wave -noupdate -radix decimal -radixshowbase 1 /frontend_tb/dut_fetch_stage/u_fetch_unit/line_bak
